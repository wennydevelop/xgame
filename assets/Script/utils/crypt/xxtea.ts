...
let makeModule=function (global) {
    ...
    function encryptToBase64Ex1(data:string,key:string){
        // return global.btoa(
    ...
    function decryptFromBase64Ex1(data:string, key:string) {
        // if (data === undefined || data === null || data.length === 0) {
        //     return data;
        // }
        // return decrypt(global.atob(data), key);
    ...
    global.XXTEA = {
        ...
        encryptToBase64Ex1:encryptToBase64Ex1,
        decryptFromBase64Ex1:decryptFromBase64Ex1,
    };
