...
let makeModule = function(global) {
    ...
    function encrypt3(data: string, key: string) {
        // return global.btoa(
        //     window['Zlib'].Deflate.compress(
        //         encrypt(data, key)
        //     )
        // );
        return encrypt2(data, key)
    }

    function decrypt3(data: string, key: string) {
        // if (data === undefined || data === null || data.length === 0) {
        //     return data;
        // }
        // return decrypt(global.atob(data), key);
        return decrypt2(data, key)
    }
...
type encryptM = {
    do: {
        encode: (str: string) => string,//utf8Encode
        decode: (str: string) => string,//utf8Decode
        encrypt: (str: string, key: string) => Array<number>,
        encrypt2: (str: string, key: string) => string,//encryptToBase64
        decrypt: (str: Array<number>, key: string) => string,
        decrypt2: (str: string, key: string) => string//decryptFromBase64
        encrypt3: (str: string, key: string) => string,//encryptToBase64Ex1
        decrypt3: (str: string, key: string) => string//decryptFromBase64Ex1
    },
    atob: (str: string) => string,
    btoa: (str: string) => string,
}
let Encrypt: encryptM = makeModule({})

export let Mencrypt = Encrypt.do
export let atob = Encrypt.atob
export let btoa = Encrypt.btoa
